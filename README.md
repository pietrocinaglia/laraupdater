...
BEFORE => Do you want contact several users and send it the update using email or a link ? 
#### LaraUpdater => Let your application (ALONE) detects that a new update is available and notifies its presence to the administrator; furthermore, let your application install it and handles all related steps.
